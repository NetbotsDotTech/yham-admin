...
import { Box, IconButton, Menu, MenuItem, Grid, Button, Typography } from '@mui/material';
...
import { AddArtifactModal } from './AddArtifact';
...
const Example = () => {
  ...
  return (
    <>
      ...
      <AddArtifactModal open={addModalOpen} handleClose={handleCloseAddModal} />
    </>
  );
};
