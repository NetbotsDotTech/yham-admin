                        ...
                        <div class="row justify-content-center">                        
                            <div class="col-lg-8 col-md-12">
                                <div class="hero-style1">
                                    <h1 class="hero-title" data-ani="slider-custom-anim-right" data-ani-delay="0.15s">Art Vista <span class="text-stroke">Artvista</span></h1>
                                    <h1 class="hero-title" data-ani="slider-custom-anim-left" data-ani-delay="0.2s">History World</h1>
                                    <h1 class="hero-title title-bg-thumb" data-bg-src="assets/img/hero/hero_1_text-bg.png" data-ani="slider-custom-anim-right" data-ani-delay="0.25s">Museum</h1>
